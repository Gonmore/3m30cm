...
- El metodo `RIM_REFERENCE` se simplifico: estima la altura de la cabeza en `APEX` respecto al aro (305 cm) y resta la estatura del atleta para obtener el salto.
